    ...
    <div class="row">
        <div class="col-xl-3 col-lg-4 col-md-5">
            <div class="sidebar-categories">
                <a href="/event"><div class="head">Program dan Kegiatan Kami</div></a>
                <ul class="main-categories">
                    @foreach ($categories as $category)
                        
                    <li class="main-nav-list"><a data-toggle="collapse" href="{{ $category->child_count > 0 ? '#'.$category->slug : url('/category/' . $category->slug) }}" aria-expanded="false" aria-controls="fruitsVegetable"><span class="lnr lnr-arrow-right"></span>{{ $category->name }}<span class="number">(53)</span></a>
                        <ul class="collapse" id="{{ $category->slug }}" data-toggle="collapse" aria-expanded="true" aria-controls="{{ $category->slug }}">
                            @foreach ($category->child as $child)
                            <li class="main-nav-list child"><a href="{{ url('/category/' . $child->slug) }}">{{ $child->name }}<span class="number">(13)</span></a></li>
                ...
                <a class="img-pop-up" target="_blank">
                  <div class="deal-details">
                    ...
                    @switch($row->status_event)
                      @case(0)
                        <h6 class="deal-title">Coming Soon insyaallah <strong>{{  $cd0/86400 + 10 }}</strong> hari lagi </h6>
                        @break
                      @case(1)
