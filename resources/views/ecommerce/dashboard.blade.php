            ...
            <div class="row gx-4">
                <div class="col-auto">
                    <div class="avatar avatar-xl position-relative">
                        <img src="{{ $member->image }}" alt="profile_image" class="w-100 border-radius-lg shadow-sm">
                    </div>
                </div>
                    ...
                    <div class="card-body p-3">
                        ...
                        <ul class="list-group">
                            <li class="list-group-item border-0 ps-0 pt-0 text-sm"><strong class="text-dark">Full
                                    Name:</strong> &nbsp; {{ $member->name }}</li>
                            <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Mobile:</strong>
                                &nbsp; {{ $member->phone_number }}</li>
                            <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Email:</strong>
                                &nbsp; <a href="/cdn-cgi/l/email-protection" class="__cf_email__"
                                    data-cfemail="87e6ebe2e4f3efe8eaf7f4e8e9c7eae6eeeba9e4e8ea">[email&#160;protected]{{ $member->email }}</a>
                            </li>
