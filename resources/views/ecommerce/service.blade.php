    ...
    <div class="container mt-5">
            ...
            <div class="row">
                <div class="col-md">
                    ...
                    <div class="info-box-content">
                        <span class="font-weight-bold">Ikhtiarkan Pencarian Jodohmu bersama layanan Taaruf Kami, khusus Alumni Kegiatan Sekolah Pranikah Masjid Salman ITB</span>
      ...
      <div class="row justify-content-center">
        <div class="col">
          ...
          <img src="{{ asset('priba/img/alurtaaruf.jpeg') }}" style="max-width: 100%; max-height: 100%;" alt="">
        </div>
      </div>
    </div>
  </div>
          ...
          <div class="section-title">
            ...
            <div class="row">
                <div class="col-md">
                    <div class="info-box">
                    <div class="info-box-content">
                        <span class="font-weight-bold">Konsultasikan segala permasalahan hidup kamu bersama Konsultan kami, ustad Bidang Dakwah.</span>
                        {{-- <span class="">Adapun beberapa program unggulan dari Bidang Dakwah adalah:</span> --}}
                    </div>
                    <!-- /.info-box-content -->
                    </div>
              ...
              <div class="card-body pt-0">
                <div class="row">
                  <div class="col-7">
                    ...
                    <p class="text-muted text-sm"><b>Spesialisasi: </b> Hukum Waris / Islam / Adab Adab / Hadits</p>
                  ...
                  <div class="col-5 text-center">
                    <img src="{{ asset('ecommerce/dist/img/imagead.png') }}" alt="Ustadz Andri" class="img-circle img-fluid">
                  </div>
                </div>
              </div>
              ...
              <div class="card-body pt-0">
                <div class="row">
                  <div class="col-7">
                    ...
                    <p class="text-muted text-sm"><b>Spesialisasi: </b> Hukum Waris / Bahasa Arab / Al Quran / Hadits </p>
                    <ul class="ml-4 mb-0 fa-ul text-muted">
                      <li class="small"><span class="fa-li"><i class="fas fa-lg fa-building"></i></span> Address: Demo Street 123, Demo City 04312, NJ</li>
                      <li class="small"><span class="fa-li"><i class="fas fa-lg fa-phone"></i></span> Phone #: + 800 - 12 12 23 52</li>
                    </ul>
                  ...
                  <div class="col-5 text-center">
                    <img src="{{ asset('ecommerce/dist/img/imagezu.png') }}" alt="Ustadz Zul" class="img-circle img-fluid">
                  </div>
                </div>
              </div>
              ...
              <div class="card-body pt-0">
                <div class="row">
                  <div class="col-7">
                    ...
                    <p class="text-muted text-sm"><b>Spesialisasi: </b> Hukum Fiqh / Hadits / Al Quran / Pernikahan </p>
                    <ul class="ml-4 mb-0 fa-ul text-muted">
                      <li class="small"><span class="fa-li"><i class="fas fa-lg fa-building"></i></span> Address: Demo Street 123, Demo City 04312, NJ</li>
                      <li class="small"><span class="fa-li"><i class="fas fa-lg fa-phone"></i></span> Phone #: + 800 - 12 12 23 52</li>
                    </ul>
                  ...
                  <div class="col-5 text-center">
                    <img src="{{ asset('ecommerce/dist/img/imageac.png') }}" alt="Ustadz Aceng" class="img-circle img-fluid">
                  </div>
                </div>
              </div>
                ...
                <div class="card-body row">
                  ...
                  <div class="col-7">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" id="reservasi" class="form-control" placeholder="Hari, Tanggal-Bulan" />
                    </div>
                    ...
                    <div class="form-group">
                      <a id="startcon" href="#" onclick="gettogetInputValue()" class="btn btn-primary"><i class="fab fa-whatsapp" aria-hidden="true"></i> Mulai Percakapan</a>
