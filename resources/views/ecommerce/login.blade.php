...
@section('title')
    <title>Login Alumni Kegiatan Bidang Dakwah</title>
@endsection
                        ...
                        <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
                            <div class="card card-plain mt-8">
                                <div class="card-header pb-0 text-left bg-transparent">
                                    <h3 class="font-weight-bolder text-info text-gradient">Welcome back Alumni</h3>
                                ...
                                <div class="card-body">
                                    <form role="form" action="{{ route('member.post_login') }}" method="post">
                                        @csrf
                                        <label>Email</label>
                                        <div class="mb-3">
                                            <input type="email"
