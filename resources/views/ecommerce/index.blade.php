...
<div class="container">
  ...
  <div class="row justify-content-center">
    <div class="col-10 info-panel">
      <div class="row">
          <div class="col-lg">
            <img src="{{ asset('priba/img/aman.png') }}" alt="aman" class="float-left rounded-circle" width="90">
            <h4>AMAN</h4>
            <p>Semoga Anda Aman bersama Kami.</p>
          </div>
          <div class="col-lg">
            <img src="{{ asset('priba/img/nyaman.png') }}" alt="nyaman" class="float-left rounded-circle" width="90">
            <h4>NYAMAN</h4>
            <p>Semoga Anda Nyaman Berada Disini.</p>
          </div>
          <div class="col-lg">
            <img src="{{ asset('priba/img/mengesankan.PNG') }}" alt="mengesankan" class="float-left rounded-circle" width="90">
            <h4>MENGESANKAN</h4>
  ...
  <div class="container">
    <div class="row justify-content-center">
        ...
        <div class="row">
          <div class="col-lg-8 col-md-8">
            <div class="single-deal">
              ...
              <img class="img-fluid w-100" src="{{ asset('priba/img/kateg4.png') }}" alt="">
          ...
          <div class="col-lg-4 col-md-4">
            <div class="single-deal">
              ...
              <img class="img-fluid w-100" src="{{ asset('priba/img/kateg3.png') }}" alt="">
          ...
          <div class="col-lg-4 col-md-4">
            <div class="single-deal">
              <div class="overlay"></div>
              <img class="img-fluid w-100" src="{{ asset('priba/img/kateg2.png') }}" alt="">
          ...
          <div class="col-lg-8 col-md-8">
            <div class="single-deal">
              <div class="overlay"></div>
              <img class="img-fluid w-100" src="{{ asset('priba/img/kateg5.png') }}" alt="">
      ...
      <div class="col-lg-4 col-md-6">
        <div class="single-deal">
          <div class="overlay"></div>
          <img class="img-fluid w-100" src="{{ asset('priba/img/kateg1.png') }}" alt="">
      ...
      <div class="row justify-content-center">
        <div class="col-lg-6 text-center">
          <div class="section-title">
            ...
            <p>Untuk Kegiatan Kami Seluruhnya <br><a href="/event"><span class="badge bg-gradient-success">View More</span></a></p>
          </div>
        </div>
      </div>
      <div class="row">
        ...
        <div class="col-lg-4 col-md-6">
            <div class="single-product">
              <div class="single-deal">
                <div class="overlay"></div>
                {{-- <img class="img-fluid w-100" src="https://source.unsplash.com/500x500?{{ $products->categpry-name }}" alt=""> --}}
                <img class="img-fluid" src="{{ asset('storage/events/' . $row->image) }}" alt="{{ $row->name }}">
                <a class="img-pop-up" target="_blank">
                  <div class="deal-details">
                    ...
                    @switch($row->status_event)
                      @case(0)
                        <h6 class="deal-title">Coming Soon <strong>{{  $cd0/86400 + 10 }}</strong> hari lagi </h6>
                        @break
                      @case(1)
                        <h6 class="deal-title">Pendaftaran berakhir <strong>{{  $cd1/86400  }}</strong> hari lagi </h6>
                        @break
                      @case(2)
                        <h6 class="deal-title">Kegiatan berakhir <strong>{{  $cd2/86400  }}</strong> hari lagi </h6>
                        @break
                            ...
                            <div class="modal-dialog">
                              <div class="modal-content bg-default">
                                ...
                                <div class="modal-body">
                                  <p>{!! $row->excerpt !!}</p>
                                  <p>Kategori: <a href="/category/{{ $row->category->slug }}">{!! $row->category->name !!}</a></p>
                                </div>
                ...
                <div class="card card-success card-outline direct-chat direct-chat-success collapsed-card">
                  ...
                  <div class="card-body">
                    <div class="direct-chat-messages">
                      <div class="direct-chat-msg">
                        ...
                        <img class="direct-chat-img" src="{{ asset('priba/img/employee.png') }}" alt="Message User Image">
                      ...
                      <div class="direct-chat-msg right">
                        <div class="direct-chat-infos clearfix">
                          <span class="direct-chat-name float-right">Admin Konsultasi Bidang Dakwah</span>
                        </div>
                        <img class="direct-chat-img" src="{{ asset('priba/img/logo-bd.png') }}" alt="Message User Image">
                        <div class="direct-chat-text">
                  ...
                  <div class="card-footer">
                      <div class="input-group">
                        <input type="text" id="message" name="message" placeholder="Kebutuhan Konsultasimu..." class="form-control">
                        <span class="input-group-append">
                          <a href="#" class="btn btn-success" onclick="getgInputValue()">Send</a>
                        </span>
                      </div>
                  </div>
                </div>
