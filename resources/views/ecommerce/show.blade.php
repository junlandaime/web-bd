...
<div class="jumbotron jumbotron-fluid" style="background: url({{ asset('priba/img/img137.jpg') }});">
    <div class="container">
			...
			<div class="row s_product_inner">
				<div class="col-lg-6">
					<div class="s_Product_carousel">
						<div class="single-prd-item">
							<img class="img-fluid" src="{{ asset('storage/events/' . $event->image) }}" alt="{{ $event->name }}">
						</div>
						{{-- <div class="single-prd-item">
							<img class="img-fluid" src="{{ asset('priba/img/workingspace3.jpg') }}" alt="">
						</div>
						<div class="single-prd-item">
							<img class="img-fluid" src="{{ asset('priba/img/workingspace3.jpg') }}" alt="">
						</div> --}}
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						...
						<span><h2>Untuk {{ $event->meet }} kali pertemuan </h2></span>
						<ul class="list">
							<li><a class="active" href="/category/{{ $event->category->slug }}"><span>Category</span> : {{ $event->category->name }}</a></li>
