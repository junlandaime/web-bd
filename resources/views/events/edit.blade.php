                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="excerpt" value="{{ $event->excerpt }}" required>
                                ...
                                <div class="row">
                                    <div class="form-group col-lg-3">
                                        ...
                                        <input class="form-control" name="published_at" type="date" value="{{ $event->published_at->format('Y-m-d') }}" id="example-date-input" required/>
                                        <p class="text-danger">{{ $errors->first('published_at') }}</p>
                                    </div>
                                    <div class="form-group col-lg-3">
                                        <label for="published_end">Publikasi Selesai</label>
                                        <input class="form-control" name="published_end" type="date" value="{{ $event->published_end->format('Y-m-d') }}" id="example-date-input" required/>
                                        <p class="text-danger">{{ $errors->first('published_end') }}</p>
                                    </div>
                                    <div class="form-group col-lg-3">
                                        <label for="event_start">Kegiatan Mulai</label>
                                        <input class="form-control" name="event_start" type="date" value="{{ $event->event_start->format('Y-m-d') }}" id="example-date-input" required/>
                                        <p class="text-danger">{{ $errors->first('event_start') }}</p>
                                    </div>
                                    <div class="form-group col-lg-3">
                                        <label for="event_end">Kegiatan Selesai</label>
                                        <input class="form-control" name="event_end" type="date" value="{{ $event->event_end->format('Y-m-d') }}" id="example-date-input" required/>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="status_event" class="form-control" required>
                                        <option value="1" {{ $event->status_event == '1' ? 'selected' : '' }}>Pendaftaran</option>
                                        <option value="0" {{ $event->status_event == '0' ? 'selected' : '' }}>Coming Soon</option>
                                        <option value="2" {{ $event->status_event == '2' ? 'selected' : '' }}>Event On Going</option>
                                        <option value="3" {{ $event->status_event == '3' ? 'selected' : '' }}>Event Selesai</option>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="category_id" id="" class="form-control">
                                        ...
                                        <option value="{{ $row->id }}" {{ $event->category_id == $row->id ? 'selected' : '' }}>{{ $row->name }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="meet" value="{{ $event->meet }}" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <img src="{{ asset('storage/events/' . $event->image) }}" width="100px" height="100px" alt="{{ $event->name }}">
                                    <hr>
